...
**No confundir con** los agentes del proceso AI-DLC (Architect Agent, Service Agent, consultive agents). Esos son herramientas del *cómo se construye*; este guide es para *qué se construye* cuando lo que construyes usa un LLM.
...
- Si usas provider externo (OpenAI/Anthropic), revisar contrato: ¿usan tus datos para training?
